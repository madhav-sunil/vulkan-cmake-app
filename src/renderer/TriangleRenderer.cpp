...
TriangleRenderer::TriangleRenderer(VkDevice device, VkRenderPass renderPass, VkExtent2D extent)
...
void TriangleRenderer::createPipeline() {
    // Load shaders
    VkShaderModule vertModule = loadShaderModule("shaders/triangle.vert.spv");
    VkShaderModule fragModule = loadShaderModule("shaders/triangle.frag.spv");
